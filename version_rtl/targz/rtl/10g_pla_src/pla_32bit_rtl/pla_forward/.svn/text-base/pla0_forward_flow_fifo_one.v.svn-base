...
module pla0_forward_flow_fifo_one
(                   
...
(*mark_debug ="true"*)    output  reg          O_flow_fifo_pause_flg         ,  /////  组1PLA对应子端口Pause 
(*mark_debug ="true"*)    output  reg          O_flow_fifo_empty             ,
(*mark_debug ="true"*)    output  reg          O_flow_para_err_flag          ,    
...
(*mark_debug ="true"*)reg [35:0]     S_ram_dout_buf3          ;
reg [35:0]    S_ram_dout_buf4          ;
reg [35:0]    S_ram_dout_buf5          ;

(*mark_debug ="true"*) reg           S_flow_data_valid        ;
(*mark_debug ="true"*) reg           S1_flow_data_valid       ;
(*mark_debug ="true"*) reg           S2_flow_data_valid       ;
(*mark_debug ="true"*) reg           S3_flow_data_valid       ;

(*mark_debug ="true"*) reg [12:0]    S_flow_fifo_wr_cnt       ;

(*mark_debug ="true"*) reg [6:0]    S_slice_rd_cnt           ;

wire          S_hc_pkt_flag_ff         ;
wire          S_ptp_header_ff          ;   ///ptp帧头指示
(*mark_debug ="true"*)reg           S1_ptp_header_ff         ; 
wire          S_pkt_pf_ff              ;   ///EVEN FLAG奇偶位                      
wire[12:0]    S_data_length_ff         ;   ///MAC包数据长度计数器 
(*mark_debug ="true"*)reg [12:0]    S1_data_length_ff        ;   ///MAC包数据长度计数器 


(*mark_debug ="true"*) reg           S_inversion_flag         ;
(*mark_debug ="true"*) reg           S_fifo_wren              ;
reg [33:0]    S1_flow_fifo_wdata       ; 
reg [33:0]    S2_flow_fifo_wdata       ; 
(*mark_debug ="true"*)reg [33:0]     S3_flow_fifo_wdata       ; 

(*mark_debug ="true"*) reg           S_flow_fifo_wren         ;
(*mark_debug ="true"*) reg[14:0]     S_flow_fifo_raddr        ;
(*mark_debug ="true"*) reg[14:0]     S_flow_fifo_waddr        ;
reg[14:0]     S_fifo_usedw_buf         ;

(*mark_debug ="true"*) reg [5:0]     S_flow_fifo_rden         ;
(*mark_debug ="true"*) reg [14:0]    S_fifo_addr_sub          ;

(*mark_debug ="true"*) reg[14:0]     S_flow_end_raddr        ;
(*mark_debug ="true"*) reg           S_flow_empty_flag;
(*mark_debug ="true"*) reg           S_flow_full_err_debug            ;  ///如下可能导致时序不过 
...
(*mark_debug ="true"*) reg           S_para_err_flag;
reg [7:0]     S_para_err_cnt;
(*mark_debug ="true"*) reg          S_para_err_rd ;

(*mark_debug ="true"*) reg   [33:0]  D_flow_fifo_next_rdata       ;  /////  组1PLA流FIFO下个数据  
(*mark_debug ="true"*) reg   [33:0]  D_flow_fifo_rdata            ;  /////  组1PLA流FIFO当前数据  
   
always @ (posedge I_pla_312m5_clk)
begin
   D_flow_fifo_next_rdata <= O_flow_fifo_next_rdata  ;
   D_flow_fifo_rdata      <= O_flow_fifo_rdata       ;
end
